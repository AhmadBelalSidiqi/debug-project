...
public class ConcertController {
    ...
    public ResponseEntity<List<Concert>> getConcertsByArtistId(@PathVariable("artistId") Long artistId){
        return ResponseEntity.ok(concertService.getConcertsByArtistId(artistId));
    }
